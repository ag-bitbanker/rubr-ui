...
const { label, transaction } = defineProps({label:string, transaction: string})
...
<template>
    <div class="flex flex-col gap-1">
        ...
        <div class="flex items-stretch flex-auto">
            <InputText
readonly pt:root="flex-1 rounded-s-md rounded-e-none" :value="transaction"
            ...
            <span
                ...
                <SecondaryButton
icon="pi pi-copy" variant="text" pt:root="rounded-none" :disabled="!address"
            ...
            <span
                ...
                <SecondaryButton
icon="pi pi-external-link" variant="text" :disabled="!url"
