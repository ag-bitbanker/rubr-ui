...
const { label = '', address= ''} = defineProps({ label: String, address: String })
...
<template>
    <div class="flex flex-col gap-1">
        ...
        <div class="flex items-stretch flex-auto">
            <InputText readonly pt:root="flex-1 rounded-s-md rounded-e-none" :value="address" :disabled="!address" />
            <span
